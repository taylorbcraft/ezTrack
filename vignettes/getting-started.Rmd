...
We pass a dataset of GPS-tagged Black-tailed Godwits to `ez_track()`. If column names aren't provided, `ez_track()` will automatically attempt to guess which columns correspond to ID, timestamp, longitude, and latitude.
...
```{r}
home_ranges_mcp <- ez_home_range(tracks, method = 'mcp', level = 50, startDate = '2025-04-12')
